...
public class AppConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/locadora/**").hasRole("ADMIN")
                .antMatchers("/locacao/**").hasRole("USER")
                .antMatchers("/locacao/**").hasRole("LOCADORA")
    ...
    public static DataSource getDataSource() throws ClassNotFoundException {
        ...
        if (dataSource == null) {
            ...
            String url = "jdbc:derby://localhost:1527/LocadoraBD2";
            String user = "root";
